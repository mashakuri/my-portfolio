      ...
      <div style={{ width: '50vw', flexShrink: 0, height: '100vh', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', padding: '30vh 72px 0 122px' }}>
        ...
        <div style={{ position: 'absolute', bottom: 64, left: 122, display: 'flex', flexDirection: 'column', gap: 14 }}>
          {[
            ...
            { href: 'https://drive.google.com/file/d/17MdolFp0cBQhCBZXnd8GJSAlXnF3fzqr/view?usp=sharing', label: 'resume', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg> },
          ].map(({ href, label, icon }) => (
